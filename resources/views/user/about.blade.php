...
<main class="main">
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav">
        <div class="container">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index-25.html">Home</a></li>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="about-text text-center mt-3">
                        ...
                        <img src="{{asset('img/category.png')}}" alt="image" class="mx-auto mb-6">
                    </div><!-- End .about-text -->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-3 ">
                        <div class="member member-2 text-center">
                            <figure class="member-media">
                                <img src="assets/images/team/about-2/member-3.jpg" class="figure-img img-fluid rounded" alt="Responsive image">
                            ...
                            <div class="member-content">
                                <h3 class="member-title">Janet Joy<span>Founder & CEO</span></h3><!-- End .member-title -->
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="member member-2 text-center">
                            <figure class="member-media">
                                <img src="{{asset('img/profile1.jpg')}}" class="figure-img img-fluid rounded" alt="member photo">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="member member-2 text-center">
                            <figure class="member-media">
                                <img src="{{asset('img/profile.jpg')}}" class="figure-img img-fluid rounded" alt="member photo">
                            ...
                            <div class="member-content">
                                <h3 class="member-title">Min Hein<span>Product Manager</span></h3><!-- End .member-title -->
                            </div><!-- End .member-content -->
                        </div><!-- End .member -->
                    </div><!-- End .col-lg-3 -->
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="member member-2 text-center">
                            <figure class="member-media">
                                <img src="assets/images/team/about-2/member-4.jpg" class="figure-img img-fluid rounded" alt="member photo">
