...
<!-- Mirrored from portotheme.com/html/molla/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Mar 2020 05:20:11 GMT -->
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Bagan Mart Electronic Ecommerce</title>
                ...
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="index-25.html" class="logo">
                            <i class="icon-fill-drip"></i><h1 style="color: black;">Bagan Mart</h1>
                        </a>
        ...
        <footer class="footer footer-2">
            <div class="footer-middle">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-5 mr-5">
                            <div class="widget widget-about">
                                <h2 class="text-light">Bagan Mart</h2>
            ...
            <div class="footer-bottom">
                <div class="container-fluid">
                    <p class="footer-copyright text-light">Developed and Updated by Min Hein</p><!-- End .footer-copyright -->
