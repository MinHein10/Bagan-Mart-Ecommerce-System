        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="banner banner-big banner-overlay">
                    <a href="#">
                    <img src="{{asset('img/home1.jpg')}}" alt="Banner">
                    </a>
            ...
            <div class="col-lg-6">
                <div class="banner banner-big banner-overlay">
                    <a href="#">
                        <img src="{{asset('img/home2.jpg')}}" alt="Banner">
                    </a>

                    <div class="banner-content banner-content-center">
                        <h3 class="banner-subtitle text-dark"><a href="#">Bagan Mart</a></h3><!-- End .banner-subtitle -->
                        <h2 class="banner-title text-dark"><a href="#">Electronic Components</a></h2><!-- End .banner-title -->
                        <a href="#" class="btn underline text-dark"><span>Discover Now</span></a>
                    </div><!-- End .banner-content -->
                </div><!-- End .banner -->
            </div><!-- End .col-lg-6 -->
        </div><!-- End .row -->
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="banner banner-overlay text-white">
                    <a href="#">
                        <img src="{{asset('img/home3.jpg')}}" alt="Banner">
                    </a>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="banner banner-overlay text-white">
                    <a href="#">
                        <img src="{{asset('img/home5.jpg')}}" alt="Banner">
                    </a>

                    <div class="banner-content">
                        <h4 class="banner-subtitle text-dark"><a href="#">BaganMart Technological Accessories</a></h4><!-- End .banner-subtitle -->
                        <h3 class="banner-title text-dark"><a href="#">2020 Year<br>up to 50% off</a></h3><!-- End .banner-title -->
                        <a href="#" class="btn underline text-dark banner-link">Shop Now</a>
                    </div><!-- End .banner-content -->
                </div><!-- End .banner -->
            </div><!-- End .col-lg-4 -->
            ...
            <div class="col-md-6 col-lg-4">
                <div class="banner banner-overlay text-white">
                    <a href="#">
                        <img src="{{asset('img/home4.jpg')}}" alt="Banner">
                    </a>
                    ...
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                        ...
                        <div class="product product-7 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                <img src="{{ asset('uploads/'.$value->Img) }}" alt="Product image" class="product-image">
                                ...
                                <a href="{{ url('add-to-cart/'.$value->id) }}" class="btn-product btn-cart"><span>add to cart</span></a>
                                </div><!-- End .product-action -->
                            </figure><!-- End .product-media -->

                            <div class="product-body">
                            <h3 class="product-title"><a href="product.html">{{$value->ProductName}}</a></h3><!-- End .product-title -->
                                ...
                                <span class="ratings-text">{{$value->Description}}</span>
